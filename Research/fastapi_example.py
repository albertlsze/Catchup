...
if __name__ == "__main__":
    # Correct Data
    user_1 = Friend(name="Albert", age=32, is_local=True)
    print(user_1.name) # Output: Albert

    # Incorrect Data (This will trigger an error!)
    ##user_2 = Friend(name="Sarah", age="thirty", is_local=True)
